...
$jsonfile = '@'+ $scriptPath + '\renew.json';
"Json file name: " + $jsonfile

curl --header 'X-Vault-Token: s.TvRfry547CMQBOl1ecy8eP8P' --request POST -v --data $jsonfile "http://localhost:8200/v1/auth/token/renew-self"